const APIKEY = "NDc1NDU0NjY3MzgwMjI4MTI5.DkfTYg.EMh_d7bICCe8LeEEQfIJn3st6Rw";
// YouTube channel ID(s)
// Can be multiple channels - eg: `array("aaaaaaaaaaaaaaaaaaaa", "bbbbbbbbbbbbbbbbbbbb")`
const CHANNELIDS = array("447849193093070848");
// Secret - must match ytnotify_subscribe script; should be reasonably hard to guess
const SECRET = "tOjiazOvmcT-M4WpdCKUnMAIQrQZD7Ej";
// Discord webhook URL
const WEBHOOKURL = "https://discordapp.com/api/webhooks/449946788527341568/ltIlv9VD_n2_YNrHJfpEaTP98MnlJPtcSIie4wrE1i5ySR6k72cNWoVeBelYdIqkwIcp";
///   ///   ///  ///   ///   ///
